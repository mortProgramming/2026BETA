...
import edu.wpi.first.wpilibj2.command.WaitCommand;
    public class TaxiLCollectHalf extends SequentialCommandGroup {
        public TaxiLCollectHalf() {
               addCommands(
