...
import edu.wpi.first.wpilibj2.command.WaitCommand;
    public class TaxiRightCollectShort extends SequentialCommandGroup {
        public TaxiRightCollectShort() {
               addCommands(
          new ParallelCommandGroup(
            ...
            new TimedDrive(1.5, 0, 2.5,-0),
              ...
              new ParallelCommandGroup(
                ...
                new TimedShoot(2, PhysicalConstants.ShooterMotorConstantsauto4.shootingVel)
                ),
                new ParallelCommandGroup(
                new ParallelCommandGroup(
                  new TimedShoot(10, PhysicalConstants.ShooterMotorConstantsauto4.shootingVel),
